<?php
  ...
  $data = $connection->query("SELECT * FROM employees");
   echo "<h1>Employee Detail & Update</h1>";
  ...
  while($row= $data->fetch(PDO::FETCH_OBJ)){
      ...
      echo "<td><a href='update.php?id={$row->id}' style='background:blue;color:white;padding:5px 10px;text-decoration:none;'>Edit</a></td>";
